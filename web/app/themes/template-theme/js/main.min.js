...
b.data("element",this.$element),b},e}),b.define("jquery-mousewheel",["jquery"],function(a){return a}),b.define("jquery.select2",["jquery","jquery-mousewheel","./select2/core","./select2/defaults"],function(a,b,c,d){if(null==a.fn.select2){var e=["open","close","destroy"];a.fn.select2=function(b){if(b=b||{},"object"==typeof b)return this.each(function(){var d=a.extend(!0,{},b);new c(a(this),d)}),this;if("string"==typeof b){var d,f=Array.prototype.slice.call(arguments,1);return this.each(function(){var c=a(this).data("select2");null==c&&window.console&&console.error&&console.error("The select2('"+b+"') method was called on an element that is not using Select2."),d=c[b].apply(c,f)}),a.inArray(b,e)>-1?this:d}throw new Error("Invalid arguments for Select2: "+b)}}return null==a.fn.select2.defaults&&(a.fn.select2.defaults=d),c}),{define:b.define,require:b.require}}(),c=b.require("jquery.select2");return a.fn.select2.amd=b,c}),jQuery(document).ready(function(a){var b=function(){var b=a(".impress-carousel-photo"),c=b.find("img"),d=c.length,e=0;c.each(function(){e++;var b=a(this).attr("src"),c=a(this).attr("class"),f=a(this).attr("alt"),g=a(this).attr("style"),h=a(this).attr("data-src"),i=a("<div></div>");i.addClass(c).addClass("property-image").attr("alt",f).attr("style",g),h&&(b=h),i.css("background-image","url("+b+")").css("display","block"),a(this).replaceWith(i),e===d&&a(".property-carousel-wrapper").css("visibility","visible")})};a(".select2-handle select").select2(),a(window).load(function(){b()}),a(".homepage-image-carousel").slick({arrows:!1})}),jQuery(document).ready(function(a){});